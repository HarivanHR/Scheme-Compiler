...
%define MAKE_LITERAL_SYMBOL(string) \
			MAKE_WORDS_LIT2 T_SYMBOL ,string
...
section .data
.msg:
	db "failed to activate prim fuction apply. Terminating" , 10, 0
...
section .data
.msg:
	db "argument isnt SOB Pair" , 10, 0
...
section .data
.msg:
	db "cannot apply non-procedure. Terminating" , 10, 0
